...
Q:保険契約が解除されるのはどのような場合ですか？
A:保険契約が解除される場合には、告知義務違反や通知義務違反、保険料の不払いなどがあります。[total_assist_yakkan_240101-2.pdf][total_assist_yakkan_240101-5.pdf][total_assist_yakkan_240101-1.pdf]<<賠償責任条項における対物事故について教えてください。>><<対人事故で支払われる保険金の種類は？>><<対人事故の示談費用について教えて。>>
###
"""
...
"""
    query_prompt_few_shots = [
        {'role' : USER, 'content' : '保険金が支払われる条件を教えてください。' },
        {'role' : ASSISTANT, 'content' : '保険金 支払 条件' },
        {'role' : USER, 'content' : '地震によって家具が壊れた場合はどのように補償されますか？' },
        {'role' : ASSISTANT, 'content' : '地震 家具 損害 補償' },
    ]
